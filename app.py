...
@app.route('/bluered.csv', methods=['GET'])
def bluered():
    return jsonify(test)

path = os.path.join(MY_PATH, './static/json/election.json')
...
path = os.path.join(MY_PATH, './static/json/gz_2010_us_040_00_500kjm.json')
with open(path, 'r') as f:
...
path = os.path.join(MY_PATH, './static/json/state_data.geojson')
with open(path, 'r') as f:
...
path = os.path.join(MY_PATH, './static/js/us_per_capita.geojson')
with open(path, 'r') as f:
...
path = os.path.join(MY_PATH, './static/js/firearm_suicides.json')
with open(path, 'r') as f:
...
path = os.path.join(MY_PATH, './static/js/firearm_homicide.json')
with open(path, 'r') as f:
